...
#include "UI/ABCharcterStatWidget.h"
#include "Components/TextBlock.h"

void UABCharcterStatWidget::NativeConstruct()
{
...
void UABCharcterStatWidget::UpdateStat(const FABCharacterStat& BaseStat, const FABCharacterStat& ModifierStat)
{
	for (TFieldIterator<FNumericProperty> PropIt(FABCharacterStat::StaticStruct()); PropIt; ++PropIt)
	{
		const FName PropKey(PropIt->GetName());
